# -*- coding: utf-8 -*-
"""
Created on Fri Dec  4 21:38:29 2020
...
from Original.out_to_in_op import OutputFormToInputFormOp
...
class Model(object):
    ...
    # [300,300],[100,50], dropout=0.5
    
    def __init__(self, t_layer_sizes, p_layer_sizes, dropout=0):
        
        self.t_layer_sizes = t_layer_sizes # [300,300]
